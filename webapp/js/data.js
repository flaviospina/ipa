...
/* ============================================================
   Frases comportamentais curtas — exibidas na escala de ordenação.
   O questionário NÃO mostra as palavras do instrumento: o respondente
   ordena descrições de comportamento (menos viés, mais concretude).
   A palavra continua sendo o código interno e aparece no relatório
   como nome do atributo.
   ============================================================ */
ACP.FRASE = {
